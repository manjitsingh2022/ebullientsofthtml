  ...
  <div class="page-wraper">
    ...
    <div class="page-content">
      ...
      <div class="main-bnr style-1">
          ...
          <div class="row align-items-center">
            <div class="col-12 text-center">
              ...
              <ul class="image-before">
                ...
                <li class="right-img">
                  <img src="images/home-banner/undraw_virtual_reality_re_yg8i.svg" alt="" />
                </li>
              </ul>
            </div>
          </div>
        ...
        <img class="bg-shape2" src="images/home-banner/shape1.png" alt="" width="60px" />
        <img class="bg-shape3" src="images/home-banner/undraw_xmas_surprise_-57-p1.svg" alt="" width="60px" />
        <img class="bg-shape4" src="images/home-banner/undraw_xmas_surprise_-57-p1.svg" alt="" width="60px" />
      </div>
      <!-- Main Banner End -->
